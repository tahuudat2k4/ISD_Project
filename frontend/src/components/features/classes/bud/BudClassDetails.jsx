            ...
            <Card className="border-0 bg-muted/60 shadow-none">
              <CardContent className="space-y-3 p-5">
                <div className="flex items-start justify-between gap-4">
                  <div>
                    <div className="text-xl font-bold">{budClass.name}</div>
                    <div className="text-sm text-muted-foreground">{budClass.code}</div>
                  </div>
                  <div className="shrink-0">{getStatusBadge(budClass.status)}</div>
                </div>
