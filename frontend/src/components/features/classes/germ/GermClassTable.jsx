...
function getCapacityBadge(current, capacity) {
  const percent = (current / capacity) * 100
  if (percent >= 90) return <Badge className="bg-red-500">Đầy</Badge>
  if (percent >= 70) return <Badge className="bg-orange-500">Gần đầy</Badge>
